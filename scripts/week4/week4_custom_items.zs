...
buildItem("scrap_crystal");                   # Scrap Crystal, compressed waste - the scrap refining line
buildFluid("molten_scrap", 0x5A5A52);         # Molten Scrap, stage 1 of the scrap refining line
